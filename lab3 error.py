...
# Frequency sweep for theoretical curve (Hz), start from 1 Hz
f_theo = np.logspace(0, 5, 1000)
w_theo = 2 * np.pi * f_theo
H = 1 / (1 - (w_theo / w0)**2 + 1j * (w_theo / w0) / q)
